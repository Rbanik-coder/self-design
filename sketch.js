...
doll = createSprite(displayWidth-300,displayHeight-230,50,50);
doll.addImage(doll1);
doll.scale=0.3;

h1 = createSprite(displayWidth-450,displayHeight-300,50,50);
h1.addImage(h);
h1.scale=0.35;

nun = createSprite(displayWidth-100,displayHeight-410,50,50);
nun.addImage(nun1);

ghost = createSprite(displayWidth-680,displayHeight-410,50,50);
